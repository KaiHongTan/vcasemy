            ...
            cases: [
                {
                    ...
                    name: 'VGO Case 1',
                    image: {
                        '300px': `0.0.0.0:${PORT}/img/img-01.png`
                    },
                    skus: [1, 2, 3, 4, 5, 6],
        },
                {
        ...
        },
                {
                    ...
                    name: 'VGO Case 4',
                    image: {
                        '300px': `http://vcase.eu-4.evennode.com/:${PORT}/img/img-01.png`
                    },
                    skus: [7, 8, 9, 10],
        },
                {
...
router.post('/ICaseSite/SendKeyRequest/v1', function (ctx) {
    ...
    if (!ctx.request.body.affiliate_eth_address) {
        ctx.status = 400;
        ctx.body = {
            error: "Missing 'affiliate_eth_address'"
        };
        return;
    }
    ...
    ctx.body = {
        ...
        response: {
                    ...
                    items: [
                        {
                            ...
                            color: '#8847ff',
                            image: {
                                '300px': 'http://vcase.eu-4.evennode.com/:${PORT}/img/img-02.png',
                                '600px': 'http://vcase.eu-4.evennode.com/:${PORT}/img/img-03.png',
                            },
                            suggested_price: 5,
            },
          ],
            ...
            offer_url: `http://vcase.eu-4.evennode.com/:${PORT}/trade_offer.html`,
        },
    };
});
